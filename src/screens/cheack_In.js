...
class cheack_In extends React.Component {
        ...
        return (
            ...
            <View style={styles.backgroundView}>
                ...
                <ScrollView >
                    ...
                    <Text style={styles.textColor}> Have you sent in your payment this week ? </Text>
                    <View style={styles.inputViwe, styles.ViewLoction}>

                        <TextInput
                            style={styles.inputLoction}
                        />
                        <TouchableOpacity style={styles.btnLoction} onPress={() => Actions.Sign()}  >
                            <Text style={styles.TextBtnLoction}>
                                CHOOSE
                         </Text>
                    ...
                    <Text style={styles.textColor}> Signature </Text>
                    <View style={styles.inputViwe, styles.ViewLoction}>
...
const styles = StyleSheet.create({
    ...
    , btnCallText2: {
        ...
        marginLeft: Dimensions.get('window').height * "0.005",
        ...
        width: Dimensions.get('window').width * "0.2",
        height: Dimensions.get('window').height * "0.07",
        bottom: Dimensions.get('window').height * "0.070",
        borderWidth: 1,
        borderRadius: 10,
        borderColor: "#bdbdbdf6",
        backgroundColor: "#bdbdbdf6",

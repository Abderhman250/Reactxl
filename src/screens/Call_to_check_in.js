                ...
                <View style={styles.Viewlogo}>
                    ...
                    <View style={styles.topText}>
                        <Text style={styles.Text1}>
                            Top the button to call the agent.
                       </Text>
                    </View>
                    ...
                    <View style={styles.StoridView}>
                        <TouchableOpacity style={styles.btnStorid} onPress={() => Actions.StoreId()} >

                            <Text style={styles.btnStoridText}>
                                Store ID
                       </Text>
                    ...
                    <View style={styles.topText}>
                        <Text style={styles.Text3}>
                            Call to to check in with your ID .
                       </Text>
                    </View>

                    <View style={styles.btnCallView}>
                        <TouchableOpacity style={styles.btnCall} onPress={() => this.linkPhone("8773200580")} >

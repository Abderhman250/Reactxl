            ...
            <Layout>
                ...
                <View style={styles.ViewTap}>
                    <View style={styles.rowTap}>
                        ...
                        <TouchableOpacity style={styles.icons}  >
                            ...
                            <AntDesign name="folderopen" size={24} color="#0b587cf6" />

                            <Text style={{ color: "#0b587cf6" }}>MY FORM</Text>
                            </TouchableOpacity>
                ...
                <View style={styles.RowButton}>
                    <TouchableOpacity onPress={() => this.chooseCategory("Network", this.props.navigation)} >
                        <Image
                            ...
                            source={require('./../../assets/btnMyForm1.png')}
                            resizeMode='stretch'
                    ...
                    <TouchableOpacity onPress={() => this.chooseCategory("Network", this.props.navigation)} >
                        <Image
                            ...
                            source={require('./../../assets/btnMyForm2.png')}
                            resizeMode='stretch'
                ...
                <View style={styles.RowButton2}>
                    <TouchableOpacity onPress={() => this.chooseCategory("Network", this.props.navigation)} >
                        <Image
                            style={styles.tinyLogo}
                            source={require('./../../assets/btnMyForm3.png')}
                            resizeMode='stretch'
                    ...
                    <TouchableOpacity onPress={() => this.chooseCategory("Network", this.props.navigation)} >
                        <Image
                            style={styles.tinyLogo1}
                            source={require('./../../assets/btnMyForm4.png')}
                            resizeMode='stretch'
                ...
                <View style={styles.RowButton3}>
                    <TouchableOpacity onPress={() => this.chooseCategory("Network", this.props.navigation)} >
                        <Image
                            style={styles.tinyLogo}
                            source={require('./../../assets/btnMyForm5.png')}
                            resizeMode='stretch'
                    ...
                    <TouchableOpacity onPress={() => this.chooseCategory("Network", this.props.navigation)} >
                        <Image
                            style={styles.tinyLogo1}
                            source={require('./../../assets/btnMyForm6.png')}
                            resizeMode='stretch'
